            ...
            <header class="mb-4">
                <div class="flex justify-between items-center">
                   ...
                   <div class="flex items-center space-x-4"> <!-- Ajout d'un container flex et espace entre les boutons -->
                       <div class="dropdown">
                       <button onclick="openBudgetModal()" class="text-l font-semibold text-white bg-gray-800 hover:bg-blue-700 text-white py-2 px-4 rounded-lg border-2 border-gray-800 hover:border-gray-800 shadow-lg transform transition duration-300 hover:scale-105">
    Calculer le Budget
</button>
...
<div id="calculateBudgetModal" class="modal">
    <div class="modal-content">
        ...
        <form id="calculateBudgetForm" action="{{ route('budget-optimisations.calculate') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="income" name="income" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                Calculer
            </button>
        </form>
        <div id="budgetResult" class="mt-4 hidden">
            <h4 class="text-lg font-semibold">Résultat du calcul du budget:</h4>
            <p><strong>Besoins (50%):</strong> <span id="needsAmount"></span></p>
            <p><strong>Envies (30%):</strong> <span id="wantsAmount"></span></p>
            <p><strong>Épargne (20%):</strong> <span id="savingsAmount"></span></p>
        </div>
    </div>
</div>
    <script>
    ...
    const modal = document.getElementById('calculateBudgetModal');
    modal.style.display = "block";
}
